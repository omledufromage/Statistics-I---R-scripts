...
# Load AIG.Stock.series in RStudio using File > Import Dataset > From text (base)...
...
plot(AIG.Stock.series.2007$Close ~ as.Date(AIG.Stock.series.2007$Date,"%m/%d/%y"),
...
smooth.trace <-  smooth.spline(as.Date(AIG.Stock.series.2007$Date,"%m/%d/%y"),AIG.Stock.series.2007$Close, spar=0.60)
